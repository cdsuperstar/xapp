  ...
  <q-page class="q-pa-md">
    ...
    >
      <div style="font-size: 30px; color: gray">
        <q-icon name="location_on"></q-icon>{{ location }}
      </div>
    </div>
    <br />
    <div style="display: flex; justify-content: center; align-items: center">
      ...
      >
        <q-btn
          @click="logout"
          style="width: 150px; background-color: rgb(210, 210, 210)"
        >
          退出登录
        </q-btn>
      </div>
    ...
    <div style="display: flex; justify-content: center; align-items: center">
      ...
      <div
        ...
        style="display: flex; justify-content: center; align-items: center"
      >
        <q-btn color="primary" to="xapp1s1shop" style="width: 150px">
          我的商铺
        </q-btn>
      </div>
    </div>
