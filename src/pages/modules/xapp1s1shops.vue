  ...
  methods: {
    initGrid() {
      ...
      this.columnDefs = [
        ...
        {
          headerName: this.$t("xapp1s1.shop.name"),
          field: "name",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.starttime"),
          field: "starttime",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.endtime"),
          field: "endtime",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.status"),
          field: "status",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.phone"),
          field: "phone",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.tel"),
          field: "tel",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("location.province"),
          field: "province",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("location.city"),
          field: "city",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("location.district"),
          field: "district",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("location.addr"),
          field: "addr",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.longitude"),
          field: "longitude",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
        ...
        {
          headerName: this.$t("xapp1s1.shop.latitude"),
          field: "latitude",
          width: 120,
          minWidth: 120,
          maxWidth: 260,
