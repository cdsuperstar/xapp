...
export default {
  ...
  system: {
    name: "Integrated intelligent management system",
  },
  message: {
    useroffline: "User offline",
    usernotliked: "User not liked",
  },
  datetime: {
    year: "Year",
    month: "Month",
  ...
  buttons: {
    ...
    comfirmtitle: "Comfirm",
    comfirmdialog:
      'Are you sure you want to do the current operation?（<span class="text-negative">This operation is irreversible!</span>）',
    send: "Send",
    confirm: "Confirm",
